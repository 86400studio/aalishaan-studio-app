...
- `P10 (Production half) · PENDING · 2026-09-24 · d416bfbe2bf94fd0e729e1ac39a5666c8a1a54ed · Production deployments qts5y2d3e and 64m890ydl (GitHub deployment 6641010256) · S0.1 record → "Closure" · protected by design until S3.4: without the bypass the production domain answers 302 (verified 2026-09-24) and through the owner-run bypass the application answers with the six headers and noindex; the PASS criterion — public Production pages working without the bypass — is a launch check (S3.4)`
