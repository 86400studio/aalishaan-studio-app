...
| Production exception owner/date/reason | The owner · 2026-09-25 · D-40: read-only verification of the SQL the owner applies to PROD by hand, and the read-only PROD negative controls of the proofs (`PROJECT-STATUS.md` §8a D-40) |
| Removal/review date | Reviewed at S1.1 Gate 0 (before customer data exists) and at S3.1 Gate 0 (before live sales); deleted unless re-approved in writing with a data classification (D-40) |
