...
- [ ] **Claude Code:** reference the secret **by name only**; attach the bypass header only to requests to the verified Preview origin, including direct HTTP tests. Disable secret-bearing traces/reports per `docs/ENVIRONMENT-PARITY.md` §10. If Preview protection is off, skip this part.
